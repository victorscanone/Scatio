...
public class CriacaoAveDesmamado implements InterfaceCriacaoDesmamado, Serializable {
    ...
    public void alimentar() {
        System.out.println("--> ANIMAIS ALIMENTADOS.");
    }
    ...
    public void adicionarNaCriacao(InterfaceAnimal animal) {
        ...
        if (animal.pegarEstado() instanceof DesmamadoState) {
            ...
            Printes.espaco();
            System.out.println("--> ESSE ANIMAL NÃO ESTÁ DENTRO DA IDADE PARA FAZER PARTE DA CRIAÇÃO OU AINDA NÃO RECEBEU UMA DATA DE NASCIMENTO.");
        }

...
public class CriacaoBovinoDesmamado implements InterfaceCriacaoDesmamado, Serializable {
    ...
    public void adicionarNaCriacao(InterfaceAnimal animal) {
        ...
        if (animal.pegarEstado() instanceof DesmamadoState) {
            animais.add(animal);
        } else {
            Printes.espaco();
            System.out.println("--> ESSE ANIMAL NÃO ESTÁ DENTRO DA IDADE PARA FAZER PARTE DA CRIAÇÃO.");
        }

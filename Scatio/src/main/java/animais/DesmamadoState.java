...
public class DesmamadoState implements InterfaceAnimalState, Serializable {
    @Override
    ...
    public InterfaceAnimalState tentarMudarEstado(LocalDate nascimento, char sexo) {
        ...
        if (idade < 5) {
            ...
            Printes.espaco();
            System.out.println("--> SEU ANIMAL CONTINUA COMO UM FILHOTE POIS TEM ENTRE 5 E 10 ANOS.");
